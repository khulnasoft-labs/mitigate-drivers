...
This is a C# AV/EDR Killer using Rogue Anti-Malware Driver 3.3. This driver is not present in the mitidrivers or Windows blocklist at the time of this writing. The only reason I&#39;m making this public is because the company has already published a fix in version 3.4, and Microsoft will likely block this driver soon. This driver can be used in Windows 23H2 with HVCI enabled, mitidrivers blocklist, or WDAC enabled. HVCI is designed to ensure the integrity of code executed in the kernel, but it cannot protect against all possible vulnerabilities or actions that can be performed through drivers or system interfaces.
- **UUID**: e0e93453-1007-4799-ad02-9b461b7e0398
- **Created**: 2023-11-10
- **Author**: ph4nt0mbyt3, Michael Haag
- **Acknowledgement**:  | [](https://twitter.com/)

{{< button "https://github.com/khulnasoft-lab/mitigate-drivers/raw/main/drivers/f53fa44c7b591a2be105344790543369.bin" "Download" >}}{{< button "https://www.khulnasoft.com/premium" "Block" "red" >}}
{{< tip "warning" >}}
...
{{< button "https://github.com/khulnasoft-lab/mitigate-drivers/raw/main/drivers/f53fa44c7b591a2be105344790543369.bin" "Download" >}} 
...
[*source*](https://github.com/khulnasoft-lab/mitigate-drivers/tree/main/yaml/e0e93453-1007-4799-ad02-9b461b7e0398.yaml)
