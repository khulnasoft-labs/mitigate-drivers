...
if __name__ == "__main__":
    ...
    # grab arguments
    parser = argparse.ArgumentParser(description="Generates mitigate-drivers.khulnasoft.com site", epilog="""
    This tool converts all mitigate-drivers.khulnasoft.com yamls and builds the site with all the supporting components.""")
    parser.add_argument("-p", "--path", required=False, default="yaml", help="path to loldriver yaml folder. Defaults to `yaml`")
    parser.add_argument("-o", "--output", required=False, default="mitigate-drivers.khulnasoft.com", help="path to the output directory for the site, defaults to `mitigate-drivers.khulnasoft.com`")
