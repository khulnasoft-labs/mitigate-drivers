...
rule $$$RULENAME$$$ {
	meta:
		description = "Detects $$$TYPE$$$ driver mentioned in mitigate-drivers project using VersionInfo values from the PE header - $$$FILENAMES$$$"
		author = "Florian Roth"
		reference = "https://github.com/khulnasoft-labs/mitigate-drivers"
		hash = "$$$HASH$$$"
		date = "$$$DATE$$$"
		score = $$$SCORE$$$
	strings:
